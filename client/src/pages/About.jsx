      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6 dark:text-white">
            <p>
              Welcome to Rayhan&apos;s Blog! This blog was created by Rayhan
              Ghavidel as a personal project to share his thoughts and ideas
              with the world. Rayhan is a passionate developer who loves to
            ...
            <p>
              ...
              programming languages. Rayhan is always learning and exploring new
